...
from app.models import User, UserRegistration, UserLogin, Token
...
def logout_user(
    ...
    """Logout user - JWT protected endpoint (client-side token removal is sufficient)"""
    # Token is validated by JWTBearer middleware
